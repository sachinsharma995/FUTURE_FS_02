<template>
  <div id="header-menu">
    ...
    >
      ...
      <b-navbar-brand to="/">
        <img
         src="https://github.com/user-attachments/assets/98a37aa3-604c-47e4-8c52-a620b89597ee" width="125px" alt="Sachin Sharma E-commerce Solution"
      >
      </b-navbar-brand>
...
import LeftMenuView from './LeftMenu.vue';
